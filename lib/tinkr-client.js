    ...
    Object.defineProperties(this, {
        ...
        pushSnapshot: {
            ...
            value: function (projectSettings, snapshotPath, options, callback) {
                ...
                rest.post(fullpath(interpolate('/projects/{name}/snapshots', projectSettings)), {
                    multipart: true,
                    data: {
                        project: projectSettings,
                        file: rest.file(snapshotPath, path.basename(snapshotPath), snapshotStat.size, 'utf8', 'application/zip')
                    }
