    ...
    Object.defineProperties(this, {
        ...
        updateProject: {
            ...
            value: function (projectSettings, callback) {
                service.put(interpolate('/project/{name}', projectSettings), {
        ...
        removeRelay: {
            writable: false,
            value: function (name, callback) {
                service.del(interpolate('/relay/{name}', { name: name }))
        ...
        changeProjectState: {
            ...
            value: function (name, version, action, callback) {
                ...
                service.post(interpolate('/project/{name}/state/{action}', {
                    name: name,
                    action: action
                }), {
                    timeout: 1000 * 120,
