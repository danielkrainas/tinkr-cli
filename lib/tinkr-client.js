    ...
    Object.defineProperties(this, {
        ...
        getProjectSnapshots: {
            ...
            value: function (project, callback) {
                rest.get(ujoin(remote, interpolate('/project/{name}/snapshots', project)), {
                    path: {
                        project: project
                    }
                }, function (data, response) {
        ...
        removeSnapshot: {
            ...
            value: function (name, version, callback) {
                rest.del(ujoin(remote, interpolate('/project/{name}/snapshots/{version}', {
                    name: name,
                    version: version
                }))).on('complete', filterError(function () {
                    callback();
        ...
        setEnvVar: {
            ...
            value: function (name, version, key, value, callback) {
                rest.post(ujoin(remote, interpolate('/project/{name}/snapshots/{version}/env', {
                    name: name,
                    version: version
                })), {
                    data: {
        ...
        delEnvVar: {
            ...
            value: function (name, version, key, callback) {
                rest.del(ujoin(remote, interpolate('/project/{name}/snapshots/{version}/env/{key}', {
                    name: name,
                    version: version,
                    key: key
                }))).on('complete', filterError(function () {
